  ...
  return (
    ...
    <nav className={`navbar fixed-top navbar-expand-lg bg-body-tertiary border-bottom bg-${props.mode}`} data-bs-theme={props.mode}>
      <div className="container-fluid">
        <Link className="navbar-brand" to="/" style={{fontFamily: 'Poppins', letterSpacing: '1px'}} onClick={() => {setPage('home')}}><img style={{width: '40px'}} src={props.imgSrc} alt="logo" /> {props.title}</Link>
